...
class RootOnlyMiddleware:
    """WSGI middleware - handle GET and POST on root, pass everything else to Flask"""
    ...
    def __call__(self, environ, start_response):
        ...
        # Handle GET or POST on root at WSGI level (zero Flask involvement)
        if path in ['/', ''] and method in ['GET', 'POST', 'HEAD']:
            status = '200 OK'
